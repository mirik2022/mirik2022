...
1.  **SQL + Дашборд (август)**
    - Взять датасет
    - Написать 5–7 аналитических SQL-запросов
    - Подключить к Power BI / Tableau, построить дашборд

2.  **Python — исследовательский анализ (Август)**
    - Датасет
    - Pandas

---

## Второе полугодие (1 Сентября 2026 – 28 Февраля 2027)
**Фаза:** Проекты → Собеседования → Отклики

### 1. Углубление + сложные проекты (Сентябрь–Октябрь)
- **SQL:** оконные функции + оптимизация (LeetCode Medium/Hard)
- **Python:** (используя знания статистики)
- **Визуализация:** усложнение дашбордов в Power BI/Tableau

### 2. Сборка портфолио (Сентябрь)
- Оформить все проекты на GitHub (Readme, комментарии, выводы)
- Собрать ссылки на дашборды (публикация в Power BI Service / Tableau Public)
- Подготовить резюме
- Первые собесы (отмечаю, что знаю, а что нет - учу, продолжаю пробовать)

### 3. Подготовка к собеседованиям (Сентября)
- **Теория:** повторение статистики, SQL-синтаксиса
- **Ресурсы:**
  - [Top Data Analyst Interview Questions 2026](https://www.dataquest.io/blog/data-analyst-interview-questions-and-answers/) 

### 4. Компании для откликов (Сентябрь – Февраль)

| Компания | Почему туда | 
|----------|-------------|
| **EPAM Systems** | есть трейни-программы |
| **iTechArt** | Много проектов под Data Analytics |
...
## Итоговый чек-лист готовности (к Январю 2027)

-  **SQL:** решено 50+ задач на LeetCode (Medium)
-   **Python:**
  -  Пройдены оба курса на Stepik
  -  2+ проекта с Pandas/Matplotlib в портфолио (EDA + что-то сложнее)
-  **BI:**
  -  Пройдены курсы по Power BI и Tableau
  -  2 дашборда (Power BI + Tableau) в портфолио
-  **Статистика:** понимаю p-value, A/B тесты, доверительные интервалы, могу применить на Python
-  **Портфолио:** оформлено на GitHub со ссылками на проекты и дашборды
-  **Отклики:** отправлено минимум 20–30 резюме в целевые компании
-  **Собеседования:** пройдено как минимум 10
